...
# -*- coding: utf-8 -*-
"""
pybcachefs documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'pybcachefs'))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, '..'))
sys.path.insert(0, src_path)

import pybcachefs  # noqa
...
project = u'pybcachefs'
_full_version = pybcachefs.__version__
author = pybcachefs.__author__
copyright = pybcachefs.__copyright__
...
htmlhelp_basename = 'pybcachefs-doc'
...
latex_documents = [
    (master_doc, 'pybcachefs.tex', u'pybcachefs Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'pybcachefs', 'pybcachefs Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pybcachefs', 'pybcachefs Documentation',
     author, 'pybcachefs', pybcachefs.__descr__,
     'Miscellaneous'),
]
